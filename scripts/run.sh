...
# 1 CPU
#./benchmark.sh java 1 single-thread-zero-logs
./benchmark.sh java 2 single-thread-zero-logs
...
# ./benchmark.sh golang 2 single-thread-zero-logs
...
./benchmark.sh java 2 two-threads-zero-logs
#./benchmark.sh java 4 four-threads-zero-logs
#./benchmark.sh java 16 sixteen-threads-zero-logs
...
./benchmark.sh java 2 two-threads-1kb-logs
#./benchmark.sh java 4 four-threads-1kb-logs
#./benchmark.sh java 16 sixteen-threads-1kb-logs
...
./benchmark.sh java 1 single-thread-1kb-logs
./benchmark.sh java 1 single-thread-5kb-logs
./benchmark.sh java 1 single-thread-10kb-logs
